...
public class Level2 implements Screen {
    ...
    private Texture redBirdTexture, blackBirdTexture, yellowBirdTexture, CatapultTexture, woodblockTexture, pigTexture,glassblockTexture;;
    private World world;
    ...
    private GameContactListener collisionListener; // Define the collisionListener
    ...
    public Level2(Game game) {
        ...
        woodblockTexture = new Texture(Gdx.files.internal("woodenblock.png"));
        glassblockTexture = new Texture(Gdx.files.internal("glassblock.png"));
        pigTexture = new Texture(Gdx.files.internal("mediumpig.png"));
    ...
    private void createGameObjects() {
        ...
        // Create blocks
        createWoodBlock(woodblockTexture, 510, 170, 50, 50);
        createGlassBlock(glassblockTexture, 510, 220, 50, 50);
        createWoodBlock(woodblockTexture, 510, 270, 50, 50);
        createWoodBlock(woodblockTexture, 560, 170, 50, 50);
        createGlassBlock(glassblockTexture, 560, 220, 50, 50);
        createWoodBlock(woodblockTexture, 610, 170, 50, 50);
        createGlassBlock(glassblockTexture, 610, 220, 50, 50);
        createGlassBlock(glassblockTexture, 610, 270, 50, 50);
        createGlassBlock(glassblockTexture, 560, 320, 50, 50);
        //createBlock(glassblockTexture, 610, 370, 50, 50);
//        createBlock(glassblockTexture, 560, 400, 200, 30);

        // Create pigs
        createPig(pigTexture, 510, 320, 50, 50);
        createPig(pigTexture, 560, 270, 50, 50);
        createPig(pigTexture, 610, 320, 50, 50);

    }

    private void createWoodBlock(Texture texture, float x, float y, float width, float height) {
        Block woodblock = new WoodenBlock(texture);
        woodblock.createBody(world, width / AngryBirds.PPM, height / AngryBirds.PPM);
        blocks.add(woodblock);
        woodblock.getBody().setTransform(x / AngryBirds.PPM, y / AngryBirds.PPM, 0);
        woodblock.getBody().setType(BodyDef.BodyType.DynamicBody);
        // Set to DynamicBody
    }
    ...
    private void createPig(Texture texture, float x, float y, float width, float height) {
