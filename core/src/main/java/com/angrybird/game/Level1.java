...
public class Level1 implements Screen {
    ...
    private Texture redBirdTexture, blackBirdTexture, yellowBirdTexture, CatapultTexture, blockTexture, pigTexture;
    private World world;
    ...
    private void createGameObjects() {
        ...
        // Create blocks
        createBlock(blockTexture, 520, 170, 50, 50);
        createBlock(blockTexture, 520, 210, 50, 50);
        createBlock(blockTexture, 520, 250, 50, 50);
        createBlock(blockTexture, 600, 170, 50, 50);
        createBlock(blockTexture, 600, 210, 50, 50);
        createBlock(blockTexture, 600, 250, 50, 50);
        createBlock(blockTexture, 680, 170, 50, 50);
        createBlock(blockTexture, 680, 210, 50, 50);
        createBlock(blockTexture, 680, 250, 50, 50);

        // Create pigs
        createPig(pigTexture, 520, 290, 30, 30);
        createPig(pigTexture, 600, 290, 30, 30);
        createPig(pigTexture, 680, 290, 30, 30);
    }

    private void createBlock(Texture texture, float x, float y, float width, float height) {
        ...
        woodblock.getBody().setType(BodyDef.BodyType.DynamicBody); // Set to DynamicBody
    }
    ...
    private void createPig(Texture texture, float x, float y, float width, float height) {
        Pig smallpig = new SmallPig(texture);
        smallpig.createBody(world, width / AngryBirds.PPM, height / AngryBirds.PPM);
        pigs.add(smallpig);
        smallpig.getBody().setTransform(x / AngryBirds.PPM, y / AngryBirds.PPM, 0);
        smallpig.getBody().setType(BodyDef.BodyType.DynamicBody);
        smallpig.setLinearDamping(0.6f);
        smallpig.getBody().setFixedRotation(false); // Allow rotation
    }
